...
import com.ledoyen.cukesalad.core.CukeSaladContextObjectFactory;
...
public class CukeSalad extends Cucumber {
	...
	static {
		...
		System.setProperty(ObjectFactory.class.getName(), CukeSaladContextObjectFactory.class.getName());
