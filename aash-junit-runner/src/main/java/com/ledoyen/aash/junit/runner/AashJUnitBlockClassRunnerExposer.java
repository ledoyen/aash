...
public class AashJUnitBlockClassRunnerExposer extends BlockJUnit4ClassRunner {

	private List<Plugin> plugins = new ArrayList<Plugin>();

	private TestContext context = new TestContext();

	public AashJUnitBlockClassRunnerExposer(Class<?> klass) throws InitializationError {
		super(klass);
	...
	public List<FrameworkMethod> getC() {
		return getChildren();
	}
	...
	public Description describeC(FrameworkMethod method) {
		return describeChild(method);
	}

	public void runC(FrameworkMethod method, RunNotifier notifier) {
